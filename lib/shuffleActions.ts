...
// Foreground-service control (precache + start/stop) lives in
// `shuffleActions.foreground.ts`; re-exported here so existing importers of
// `lib/shuffleActions` keep working unchanged.
export {
  precacheCollection,
  startForegroundShuffleForCollection,
  stopForegroundShuffle,
} from './shuffleActions.foreground';
