...
import { applyNext, isInDndWindow } from './shuffleApply';
import { type EngineStatus } from './shuffleEngine.types';
...
// `EngineStatus` lives in ./shuffleEngine.types now; re-exported here so
// external importers keep their import path unchanged. The pure
// apply/DND helpers moved to ./shuffleApply.
export { type EngineStatus } from './shuffleEngine.types';
